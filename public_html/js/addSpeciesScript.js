...
document.getElementById('enterSpecies').addEventListener('click', function(event){
  ...
  let payload = '?family='+familyInput+'&genus='+genusInput+'&specific_epithet='
  + specificEpithetInput+'&year='+yearInput+'&appID='+userId;
  
  //open the request to /addSpecies
  req.open('GET','https://johnhash.me/flies/addSpecies'+payload, true);
